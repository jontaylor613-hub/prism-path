 ...
 * 
 * File: /components/features/ImportRoster.jsx
 * 
...
import { importStudentsFromCSV } from '../../lib/studentService';
...
export default function ImportRoster({ 
  ...
  const handleConfirmImport = async () => {
    ...
    try {
      ...
      if (onStudentsUpdate) {
        // Trigger a refresh - parent should call getStudents() from studentService
