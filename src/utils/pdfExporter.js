...
export async function generatePDF(title, content, schoolName = '', appName = 'PrismPath™', fontFamily = 'arial') {
  ...
  // Set font - Use Arial (helvetica) as default, Times New Roman available as 'times'
  // Note: jsPDF uses 'helvetica' for Arial and 'times' for Times New Roman
  const font = fontFamily === 'times' ? 'times' : 'helvetica';
  doc.setFont(font); // Arial (helvetica) or Times New Roman (times)
  doc.setFontSize(10);
